...
public class QmsQualityTarget extends BaseEntity {
    ...
    @Excel(name = "目标合格率(%)") private BigDecimal targetPassRate;
    @Excel(name = "实际合格率(%)") private BigDecimal actualPassRate;
    @Excel(name = "目标PPM") private Integer targetPpm;
    @Excel(name = "实际PPM") private Integer actualPpm;
    @Excel(name = "目标客诉率(%)") private BigDecimal targetComplaintRate;
    @Excel(name = "实际客诉率(%)") private BigDecimal actualComplaintRate;
    @Excel(name = "目标CAPA关闭率(%)") private BigDecimal targetCapaCloseRate;
    @Excel(name = "实际CAPA关闭率(%)") private BigDecimal actualCapaCloseRate;

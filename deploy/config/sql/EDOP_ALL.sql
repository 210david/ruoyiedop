...
CREATE TABLE `dms_equipment` (
  ...
  `asset_code` varchar(128) DEFAULT NULL COMMENT '资产编号',
  ...
  `equipment_level` varchar(10) DEFAULT NULL COMMENT '设备等级（字典 dms_equipment_level）',
  `warranty_date` date DEFAULT NULL COMMENT '质保期限',
...
CREATE TABLE `dms_work_order` (
  ...
  `repair_cost` decimal(12,2) DEFAULT NULL COMMENT '维修费用（元）',

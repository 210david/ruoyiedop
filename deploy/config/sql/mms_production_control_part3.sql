...
(2064, 4, '报工中',     '3', 'mms_workorder_status', '', 'primary', 'N', '0', 'admin', sysdate(), '', NULL, '报工中'),
(2065, 5, '待完工质检', '4', 'mms_workorder_status', '', 'warning', 'N', '0', 'admin', sysdate(), '', NULL, '待完工质检'),
(2066, 6, '完工入库',   '5', 'mms_workorder_status', '', 'success', 'N', '0', 'admin', sysdate(), '', NULL, '完工入库'),
(2067, 7, '已关闭',     '6', 'mms_workorder_status', '', 'info', 'N', '0', 'admin', sysdate(), '', NULL, '已关闭'),
(2068, 8, '已暂停',     '7', 'mms_workorder_status', '', 'danger', 'N', '0', 'admin', sysdate(), '', NULL, '已暂停'),
(2069, 9, '已作废',     '8', 'mms_workorder_status', '', 'danger', 'N', '0', 'admin', sysdate(), '', NULL, '已作废'),
-- 工序类型

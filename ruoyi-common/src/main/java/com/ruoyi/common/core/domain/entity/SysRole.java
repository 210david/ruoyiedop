...
public class SysRole extends BaseEntity
{
    ...
    /** 角色分类（业务模块：system系统管理 dms设备管理 pms采购管理 mk营销管理 wms仓储管理 safety安全生产管理 qms质量管理 mms生产管控，支持多选用逗号分隔） */
    @Excel(name = "角色分类", readConverterExp = "system=系统管理,dms=设备管理,pms=采购管理,mk=营销管理,wms=仓储管理,safety=安全生产管理,qms=质量管理,mms=生产管控")

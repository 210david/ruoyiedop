...
const WMS_MODULES = [
  ...
  "remark": "月度全盘"
      ...
      }),
      {
        ...
        summary: '开始盘点',
        permission: 'wms:stocktake:start',
      ...
      },
      {
        ...
        summary: '提交盘点明细',
        permission: 'wms:stocktake:input',
        params: [
      ...
      },
      {
        ...
        summary: '盘点审批',
        permission: 'wms:stocktake:approve',
        params: [{ name: 'takeId', type: 'Long', required: true, desc: '盘点单ID', in: 'path' }],
...
const DMS_MODULES = [
  ...
  "remark": "紧急维修"
      ...
      }),
      {
        ...
        summary: '工单派工',
        permission: 'dms:workorder:dispatch',
        params: [
  ...
  "assigneeId": 10
      ...
      },
      {
        ...
        summary: '工单改派',
        permission: 'dms:workorder:reassign',
        params: [
          { name: 'orderId', type: 'Long', required: true, desc: '工单ID', in: 'body' },
  ...
  "assigneeId": 11
      ...
      },
      {
        ...
        summary: '工单接单',
        permission: 'dms:workorder:accept',
      ...
      },
      {
        ...
        summary: '开始处理',
        permission: 'dms:workorder:process',
        params: [{ name: 'orderId', type: 'Long', required: true, desc: '工单ID', in: 'path' }],
      ...
      },
      {
        ...
        summary: '工单完工',
        permission: 'dms:workorder:complete',
        params: [
          { name: 'orderId', type: 'Long', required: true, desc: '工单ID', in: 'body' },
  ...
  "usedParts": [
    { "partId": 5, "usedQty": 2 }
      ...
      },
      {
        ...
        summary: '验收通过',
        permission: 'dms:workorder:verify',
        params: [
          { name: 'orderId', type: 'Long', required: true, desc: '工单ID', in: 'body' },
  ...
  "verifyRemark": "维修质量合格"
      ...
      },
      {
        ...
        summary: '驳回重做',
        permission: 'dms:workorder:reject',
        params: [
          { name: 'orderId', type: 'Long', required: true, desc: '工单ID', in: 'body' },
  ...
  "rejectReason": "故障未完全排除"
      ...
      },
      {
        ...
        summary: '工单撤销',
        permission: 'dms:workorder:cancel',
        params: [{ name: 'orderId', type: 'Long', required: true, desc: '工单ID', in: 'path' }],
...

  {
    ...
    apis: [
      ...
      }),
      {
        ...
        summary: '领取线索',
        permission: 'marketing:lead:pool:receive',
      ...
      },
      {
        ...
        summary: '审批通过领取申请',
        permission: 'marketing:lead:pool:approve',
        params: [{ name: 'leadId', type: 'Long', required: true, desc: '线索ID', in: 'path' }],

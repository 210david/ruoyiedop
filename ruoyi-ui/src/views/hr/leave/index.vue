<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button type="success" plain icon="Edit" :disabled="single" @click="handleUpdate" v-hasPermi="['hr:leave:edit']">修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger" plain icon="Delete" :disabled="multiple" @click="handleDelete" v-hasPermi="['hr:leave:remove']">删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="warning" plain icon="Download" @click="handleExport" v-hasPermi="['hr:leave:export']">导出</el-button>
      </el-col>
      <right-toolbar v-model:showSearch="showSearch" @queryTable="getList"></right-toolbar>
    </el-row>

    <!-- 数据表格 -->
    <el-table v-loading="loading" :data="hrLeaveList" @selection-change="handleSelectionChange" border>
      <el-table-column type="selection" width="55" align="center" />
      <el-table-column label="序号" type="index" width="60" align="center" />
      <el-table-column label="离职单号" prop="leaveNo" align="center"  />
      ...
      <el-table-column label="离职类型" prop="leaveType" align="center"  />
      <el-table-column label="离职日期" prop="leaveDate" align="center" width="120" />
      <el-table-column label="离职原因" prop="reason" align="center"  />
      <el-table-column label="交接状态" prop="handoverStatus" align="center"  />
    ...
    <!-- 新增/修改对话框 -->
    <el-dialog v-model="open" width="800px" title="离职" append-to-body>
      <el-form ref="hrLeaveRef" :model="form" :rules="rules" label-width="100px">
        <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item label="离职单号" prop="leaveNo">
            <el-input v-model="form.leaveNo" placeholder="请输入离职单号" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="员工ID" prop="employeeId">
        ...
        <el-col :span="12">
          <el-form-item label="离职类型" prop="leaveType">
            <el-input v-model="form.leaveType" placeholder="请输入离职类型" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
        ...
        <el-col :span="12">
          <el-form-item label="补偿类型" prop="compensationType">
            <el-input v-model="form.compensationType" placeholder="请输入补偿类型" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="补偿金额" prop="compensationAmount">
            <el-input-number v-model="form.compensationAmount" :precision="2" :min="0" controls-position="right" style="width: 100%" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="未休年假天数" prop="annualLeaveBalance">
            <el-input-number v-model="form.annualLeaveBalance" :precision="2" :min="0" controls-position="right" style="width: 100%" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="年假折算金额" prop="annualLeaveAmount">
            <el-input-number v-model="form.annualLeaveAmount" :precision="2" :min="0" controls-position="right" style="width: 100%" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="结算总金额" prop="settlementAmount">
            <el-input-number v-model="form.settlementAmount" :precision="2" :min="0" controls-position="right" style="width: 100%" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="离职证明编号" prop="certificateNo">
            <el-input v-model="form.certificateNo" placeholder="请输入离职证明编号" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
...
import { listHrLeave, getHrLeave, addHrLeave, updateHrLeave, delHrLeave } from '@/api/hr/hrLeave'
...
const data = reactive({
  form: {},
  queryParams: { pageNum: 1, pageSize: 10, leaveNo: undefined, employeeId: undefined, employeeName: undefined, employeeNo: undefined },
  rules: {
    leaveNo: [{ required: true, message: '离职单号不能为空', trigger: 'blur' }],

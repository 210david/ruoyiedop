  ...
  <div class="app-container">
    ...
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="80px">
      <el-form-item label="考勤日期" prop="recordDate">
        <el-input v-model="queryParams.recordDate" placeholder="请输入考勤日期" clearable @keyup.enter="handleQuery" />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button type="success" plain icon="Edit" :disabled="single" @click="handleUpdate" v-hasPermi="['hr:attendance:edit']">修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger" plain icon="Delete" :disabled="multiple" @click="handleDelete" v-hasPermi="['hr:attendance:remove']">删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="warning" plain icon="Download" @click="handleExport" v-hasPermi="['hr:attendance:export']">导出</el-button>
      </el-col>
      <right-toolbar v-model:showSearch="showSearch" @queryTable="getList"></right-toolbar>
    </el-row>

    <!-- 数据表格 -->
    <el-table v-loading="loading" :data="hrAttendanceRecordList" @selection-change="handleSelectionChange" border>
      <el-table-column type="selection" width="55" align="center" />
      <el-table-column label="序号" type="index" width="60" align="center" />
      <el-table-column label="考勤日期" prop="recordDate" align="center" width="120" />
      ...
      <el-table-column label="上班打卡" prop="clockIn" align="center" width="120" />
    ...
    <!-- 新增/修改对话框 -->
    <el-dialog v-model="open" width="800px" title="考勤记录" append-to-body>
      <el-form ref="hrAttendanceRecordRef" :model="form" :rules="rules" label-width="100px">
        ...
        <el-col :span="12">
          <el-form-item label="上班打卡" prop="clockIn">
            <el-date-picker v-model="form.clockIn" type="date" value-format="YYYY-MM-DD" placeholder="选择日期" style="width: 100%" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="下班打卡" prop="clockOut">
            <el-date-picker v-model="form.clockOut" type="date" value-format="YYYY-MM-DD" placeholder="选择日期" style="width: 100%" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="上班来源" prop="clockInSource">
            <el-input v-model="form.clockInSource" placeholder="请输入上班来源" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="下班来源" prop="clockOutSource">
            <el-input v-model="form.clockOutSource" placeholder="请输入下班来源" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="迟到分钟" prop="lateMinutes">
            <el-input-number v-model="form.lateMinutes" :precision="0" :min="0" controls-position="right" style="width: 100%" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="早退分钟" prop="earlyMinutes">
            <el-input-number v-model="form.earlyMinutes" :precision="0" :min="0" controls-position="right" style="width: 100%" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="考勤状态" prop="attendanceStatus">
            <el-input v-model="form.attendanceStatus" placeholder="请输入考勤状态" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
...
const data = reactive({
  form: {},
  queryParams: { pageNum: 1, pageSize: 10, recordDate: undefined, employeeId: undefined, employeeName: undefined, employeeNo: undefined },
  rules: {

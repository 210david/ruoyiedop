    ...
    <div class="surface">
      ...
      <div class="table-wrap">
        <el-table ref="tableRef" v-loading="loading" :data="enterpriseList" border @selection-change="handleSelectionChange" @header-dragend="onHeaderDragEnd" @sort-change="handleSortChange" class="app-table">
          ...
          <el-table-column label="企业名称" prop="enterpriseName" key="enterpriseName" :width="colWidth('enterpriseName', 200)" resizable show-overflow-tooltip v-if="columns.enterpriseName.visible" />

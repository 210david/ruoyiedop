    ...
    <div class="surface">
      ...
      <div class="table-wrap">
        <el-table ref="tableRef" border v-loading="loading" :data="list" @selection-change="handleSelectionChange" @header-dragend="onHeaderDragEnd" class="app-table">
          ...
          <el-table-column label="量检具编号" prop="gaugeNo" :width="colWidth('gaugeNo', 140)" resizable show-overflow-tooltip />
          <el-table-column label="量检具名称" prop="gaugeName" :width="colWidth('gaugeName', 180)" resizable show-overflow-tooltip />
          <el-table-column label="类型" prop="gaugeType" :width="colWidth('gaugeType', 120)" resizable align="center">
            <template #default="scope"><dict-tag :options="qms_gauge_type" :value="scope.row.gaugeType" /></template>
          </el-table-column>
          <el-table-column label="精度" prop="precisionVal" :width="colWidth('precisionVal', 100)" resizable align="center" />
          <el-table-column label="测量范围" prop="measureRange" :width="colWidth('measureRange', 140)" resizable show-overflow-tooltip />
          <el-table-column label="校准周期(月)" prop="calibCycle" :width="colWidth('calibCycle', 110)" resizable align="center" />
          <el-table-column label="上次校准日期" prop="lastCalibDate" :width="colWidth('lastCalibDate', 120)" resizable align="center" />
          <el-table-column label="下次校准日期" prop="nextCalibDate" :width="colWidth('nextCalibDate', 120)" resizable align="center" />
          <el-table-column label="量检具状态" prop="gaugeStatus" :width="colWidth('gaugeStatus', 100)" resizable align="center">
        ...
        <div class="rd-page">
          <section class="rd-card">
            ...
            <div class="rd-card-body">
              ...
              <el-row :gutter="20">
                <el-col :span="12"><el-form-item label="类型" prop="gaugeType">
          ...
          <section class="rd-card">
            ...
            <div class="rd-card-body">
              <el-row :gutter="20">
                <el-col :span="12"><el-form-item label="上次校准日期" prop="lastCalibDate"><el-date-picker v-model="form.lastCalibDate" type="date" value-format="YYYY-MM-DD" placeholder="选择日期" style="width: 100%" /></el-form-item></el-col>
                <el-col :span="12"><el-form-item label="下次校准日期" prop="nextCalibDate"><el-date-picker v-model="form.nextCalibDate" type="date" value-format="YYYY-MM-DD" placeholder="选择日期" style="width: 100%" /></el-form-item></el-col>
              </el-row>
              <el-row :gutter="20">
                <el-col :span="12"><el-form-item label="校准周期(月)" prop="calibCycle"><el-input-number v-model="form.calibCycle" :min="1" :max="120" style="width: 100%" /></el-form-item></el-col>
              </el-row>
            </div>
          </section>
          <section class="rd-card">
            ...
            <div class="rd-card-body">
              <el-row :gutter="20">
                <el-col :span="12"><el-form-item label="量检具状态" prop="gaugeStatus"><el-select v-model="form.gaugeStatus" style="width: 100%"><el-option v-for="d in qms_gauge_status" :key="d.value" :label="d.label" :value="d.value" /></el-select></el-form-item></el-col>
      ...
      <div class="rd-page">
        <section class="rd-card">
          ...
          <div class="rd-card-body" style="display:block"><div class="rd-grid">
            ...
            <div class="rd-item"><span class="rd-label">类型</span><div class="rd-value"><dict-tag :options="qms_gauge_type" :value="viewData.gaugeType" /></div></div>
            ...
            <div class="rd-item"><span class="rd-label">量检具状态</span><div class="rd-value">{{ gaugeStatusLabel(viewData.gaugeStatus) }}</div></div>
          </div></div>
        </section>
        <section class="rd-card">
          <div class="rd-card-header"><div class="rd-card-title"><span class="rd-card-icon"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg></span>校准信息</div></div>
          <div class="rd-card-body" style="display:block"><div class="rd-grid">
            <div class="rd-item"><span class="rd-label">校准周期(月)</span><div class="rd-value">{{ viewData.calibCycle != null ? viewData.calibCycle : '-' }}</div></div>
            <div class="rd-item"><span class="rd-label">上次校准日期</span><div class="rd-value">{{ viewData.lastCalibDate || '-' }}</div></div>
            <div class="rd-item"><span class="rd-label">下次校准日期</span><div class="rd-value">{{ viewData.nextCalibDate || '-' }}</div></div>
...
const data = reactive({
  form: {},
  queryParams: { pageNum: 1, pageSize: 10, gaugeNo: undefined, gaugeName: undefined, gaugeStatus: undefined, status: undefined, params: {} },
  rules: {
...
function resetQuery() { queryParams.value.gaugeNo = undefined; queryParams.value.gaugeName = undefined; queryParams.value.gaugeStatus = undefined; queryParams.value.status = undefined; queryParams.value.params = {}; handleQuery() }
...
function handleExport() { proxy.download('qms/gauge/export', { ...queryParams.value }, `gauge_${new Date().getTime()}.xlsx`) }
...
.qms-gauge-page .field label { font-size:14px; font-weight:500; color:var(--ink-700); }

    ...
    <div class="surface">
      ...
      <div class="table-wrap">
        <el-table ref="tableRef" border v-loading="loading" :data="list" @selection-change="handleSelectionChange" @header-dragend="onHeaderDragEnd" class="app-table">
          ...
          <el-table-column label="文档编号" prop="docNo" :width="colWidth('docNo', 160)" resizable show-overflow-tooltip />
          <el-table-column label="标题" prop="docTitle" :width="colWidth('docTitle', 220)" resizable show-overflow-tooltip />
          <el-table-column label="分类" prop="docCategory" :width="colWidth('docCategory', 120)" resizable align="center"><template #default="scope"><dict-tag :options="categoryOptions" :value="scope.row.docCategory" /></template></el-table-column>
          <el-table-column label="版本" prop="versionNo" :width="colWidth('versionNo', 100)" resizable align="center" />
          <el-table-column label="归属部门" prop="deptName" :width="colWidth('deptName', 140)" resizable show-overflow-tooltip />
          <el-table-column label="状态" prop="docStatus" :width="colWidth('docStatus', 100)" resizable align="center"><template #default="scope"><dict-tag :options="statusOptions" :value="scope.row.docStatus" /></template></el-table-column>
          <el-table-column label="生效日期" prop="publishDate" :width="colWidth('publishDate', 120)" resizable align="center"><template #default="scope"><span>{{ parseTime(scope.row.publishDate, '{y}-{m}-{d}') }}</span></template></el-table-column>
        ...
        <div class="rd-page">
          ...
          <section class="rd-card">
            ...
            <div class="rd-card-body" v-show="!collapsedCards.c0">
              <el-row :gutter="20">
                <el-col :span="12"><el-form-item label="文档编号" prop="docNo"><el-input v-model="form.docNo" placeholder="请输入" /></el-form-item></el-col>
...
const rules = { docNo: [{ required: true, message: '请输入文档编号', trigger: 'blur' }], docTitle: [{ required: true, message: '请输入文档标题', trigger: 'blur' }] }
...
function handleExport() { proxy.download('qms/doc/export', { ...queryParams.value }, `doc_${new Date().getTime()}.xlsx`) }
/** 打开部门选择弹窗 */
...
.qms-doc-page .field label { font-size:14px; font-weight:500; color:var(--ink-700); }

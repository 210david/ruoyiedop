    ...
    <div class="surface">
      ...
      <div class="table-wrap">
        <el-table ref="tableRef" border v-loading="loading" :data="list" @selection-change="handleSelectionChange" @header-dragend="onHeaderDragEnd" class="app-table">
          ...
          <el-table-column label="检验类型" prop="inspectTypes" :width="colWidth('inspectTypes', 200)" resizable align="center">
          ...
          <el-table-column label="行业模板" prop="tplName" :width="colWidth('tplName', 140)" resizable align="center" />
          <el-table-column label="是否免检" prop="isExempt" :width="colWidth('isExempt', 100)" resizable align="center">
              ...
              <el-row :gutter="20">
                <el-col :span="12">
                  <el-form-item prop="inspectTypes">
                    ...
                    <el-checkbox-group v-model="inspectTypeArr">
...
const data = reactive({
  form: {},
  queryParams: { pageNum: 1, pageSize: 10, materialCode: undefined, materialName: undefined, isExempt: undefined, status: undefined, params: {} },
  rules: {
...
function resetQuery() { queryParams.value.materialCode = undefined; queryParams.value.materialName = undefined; queryParams.value.isExempt = undefined; queryParams.value.status = undefined; queryParams.value.params = {}; handleQuery() }
...
function reset() { form.value = { attrId: undefined, materialId: undefined, materialCode: undefined, materialName: undefined, inspectTypes: undefined, tplId: undefined, isExempt: '0', status: '0', remark: undefined }; inspectTypeArr.value = [] }
function loadTplOptions() { listTpl({ pageNum: 1, pageSize: 999, status: '0' }).then(res => { tplOptions.value = res.rows || [] }) }
...
function handleExport() { proxy.download('qms/materialattr/export', { ...queryParams.value }, `materialattr_${new Date().getTime()}.xlsx`) }
...
.qms-mattr-page .field label { font-size:14px; font-weight:500; color:var(--ink-700); }

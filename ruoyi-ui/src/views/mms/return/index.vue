    ...
    <el-dialog v-model="confirmOpen" width="1032px" append-to-body draggable class="rd-dialog">
      ...
      <div class="rd-page">
        ...
        <section class="rd-card">
          ...
          <div class="rd-card-body" v-show="!collapsedCards.cc0" style="display:block;padding:19px 24px"><el-form ref="confirmFormRef" :model="confirmData" label-width="100px" size="default"><el-row :gutter="20"><el-col :span="8"><el-form-item label="退料编号"><span class="rd-static-text">{{ confirmData.returnNo || '-' }}</span></el-form-item></el-col><el-col :span="8"><el-form-item label="领料单号"><span class="rd-static-text">{{ confirmData.issueNo || '-' }}</span></el-form-item></el-col><el-col :span="8"><el-form-item label="工单编号"><span class="rd-static-text">{{ confirmData.workOrderNo || '-' }}</span></el-form-item></el-col></el-row><el-row :gutter="20"><el-col :span="8"><el-form-item label="产品编码"><span class="rd-static-text">{{ confirmData.productCode || '-' }}</span></el-form-item></el-col><el-col :span="8"><el-form-item label="产品名称"><span class="rd-static-text">{{ confirmData.productName || '-' }}</span></el-form-item></el-col><el-col :span="8"><el-form-item label="当前状态"><dict-tag :options="mms_return_status" :value="confirmData.status" /></el-form-item></el-col></el-row><el-row :gutter="20"><el-col :span="12"><el-form-item label="退料人" prop="returnBy" :rules="[{ required: true, message: '请选择退料人', trigger: 'change' }]"><el-input v-model="confirmData.returnBy" readonly placeholder="请选择退料人" style="width: 100%" @click="openConfirmReturnByPicker"><template #append><el-button icon="Search" @click="openConfirmReturnByPicker" /></template><template #suffix><el-icon v-if="confirmData.returnBy" class="rd-form-tip" style="cursor:pointer" @click.stop="confirmData.returnBy = undefined"><CircleClose /></el-icon></template></el-input></el-form-item></el-col><el-col :span="12"><el-form-item label="退料时间" prop="returnTime" :rules="[{ required: true, message: '请选择退料时间', trigger: 'change' }]"><el-date-picker v-model="confirmData.returnTime" type="datetime" placeholder="选择退料时间" value-format="YYYY-MM-DD HH:mm:ss" style="width: 100%" /></el-form-item></el-col></el-row><el-row :gutter="20"><el-col :span="24"><el-form-item label="退料原因" prop="returnReason"><el-input v-model="confirmData.returnReason" type="textarea" :rows="2" placeholder="请输入退料原因" /></el-form-item></el-col></el-row></el-form></div>
        </section>
        <section class="rd-card">

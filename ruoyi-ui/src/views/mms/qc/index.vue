        ...
        <div class="rd-page">
          <section class="rd-card">
            ...
            <div class="rd-card-body" v-show="!collapsedCards.c0">
              ...
              <el-row :gutter="20" v-if="form.productName"><el-col :span="12"><el-form-item label="产品编码"><el-input v-model="form.productCode" disabled /></el-form-item></el-col><el-col :span="12"><el-form-item label="产品名称"><el-input v-model="form.productName" disabled /></el-form-item></el-col></el-row>
              <el-row :gutter="20" v-if="form.productName"><el-col :span="8"><el-form-item label="规格型号"><el-input v-model="form.specModel" disabled /></el-form-item></el-col><el-col :span="8"><el-form-item label="单位"><el-select v-model="form.unit" disabled style="width: 100%"><el-option v-for="d in wms_unit" :key="d.value" :label="d.label" :value="d.value" /></el-select></el-form-item></el-col><el-col :span="8"><el-form-item label="工单数量"><el-input v-model="form.planQty" disabled /></el-form-item></el-col></el-row>
        ...
        <div class="rd-page">
          <section class="rd-card">
            ...
            <div class="rd-card-body" v-show="!collapsedCards.i0">
              ...
              <el-row :gutter="20" v-if="inspectForm.productName"><el-col :span="12"><el-form-item label="产品编码"><el-input v-model="inspectForm.productCode" disabled /></el-form-item></el-col><el-col :span="12"><el-form-item label="产品名称"><el-input v-model="inspectForm.productName" disabled /></el-form-item></el-col></el-row>
              <el-row :gutter="20" v-if="inspectForm.productName"><el-col :span="8"><el-form-item label="规格型号"><el-input v-model="inspectForm.specModel" disabled /></el-form-item></el-col><el-col :span="8"><el-form-item label="单位"><el-select v-model="inspectForm.unit" disabled style="width: 100%"><el-option v-for="d in wms_unit" :key="d.value" :label="d.label" :value="d.value" /></el-select></el-form-item></el-col><el-col :span="8"><el-form-item label="工单数量"><el-input v-model="inspectForm.planQty" disabled /></el-form-item></el-col></el-row>
